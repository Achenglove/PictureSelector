...
public class CCRBindingRecyclerViewAdapter<M, B extends ViewDataBinding> extends RecyclerView.Adapter<CCRBindingViewHolder<B>> {
    ...
    public void onBindViewHolder(CCRBindingViewHolder<B> viewHolder, int position) {
        ...
        binding.setVariable(com.pasture.baseadapterlib.BR.viewHolder, viewHolder);
        binding.setVariable(com.pasture.baseadapterlib.BR.uiHandler, mUiHandler);
        binding.setVariable(com.pasture.baseadapterlib.BR.statusModel, mStatusModel);
        binding.setVariable(com.pasture.baseadapterlib.BR.model, model);
