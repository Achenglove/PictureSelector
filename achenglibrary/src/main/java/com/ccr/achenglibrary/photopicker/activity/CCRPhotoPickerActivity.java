...
//        intent.setType("video/*;image/*");// 相片类型
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        if (imageDir != null) {
            ...
            mImageCaptureManager = new CCRImageCaptureManager(imageDir);
        }
        // 获取图片选择的最大张数
        ...
        mContentRv.addItemDecoration(new CCRSpaceItemDecoration(getResources().getDimensionPixelSize(R.dimen.bga_pp_size_photo_divider)));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_CODE_TAKE_PHOTO) {
                ...
                startActivityForResult(CCRPhotoPickerPreviewActivity.newIntent(this, 1, photos, photos, 0, true), REQUEST_CODE_PREVIEW);
                ...
                returnSelectedImages(CCRPhotoPickerPreviewActivity.getSelectedImages(data));
            }
            ...
            if (CCRPhotoPickerPreviewActivity.getIsFromTakePhoto(data)) {
                ...
                mPicAdapter.setSelectedImages(CCRPhotoPickerPreviewActivity.getSelectedImages(data));
                renderTopRightBtn();
            }
        }
    }
    ...
    private void changeToPreview(int position) {
        ...
        startActivityForResult(CCRPhotoPickerPreviewActivity.newIntent(this, mMaxChooseCount, mPicAdapter
    ...
    @Override
    public void onPostExecute(ArrayList<CCRImageFolderModel> imageFolderModels) {
