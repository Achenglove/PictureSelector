...
public class MomentAddActivity extends CCRPPToolbarActivity implements EasyPermissions.PermissionCallbacks, CCRSortableNinePhotoLayout.Delegate {
    ...
    public void onClickNinePhotoItem(CCRSortableNinePhotoLayout sortableNinePhotoLayout, View view, int position, String model, ArrayList<String> models) {
        startActivityForResult(CCRPhotoPickerPreviewActivity.newIntent(this, mPhotosSnpl.getMaxItemCount(), models, models, position, false), REQUEST_CODE_PHOTO_PREVIEW);
    }
    ...
    private void choicePhotoWrapper() {
        ...
        if (EasyPermissions.hasPermissions(this, perms)) {
            ...
            startActivityForResult(CCRPhotoPickerActivity.newIntent(this, mTakePhotoCb.isChecked() ? takePhotoDir : null, mPhotosSnpl.getMaxItemCount() - mPhotosSnpl.getItemCount(), null, false), REQUEST_CODE_CHOOSE_PHOTO);
        } else {
