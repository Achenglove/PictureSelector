...
import cn.bingoogolapple.photopicker.activity.CCRPhotoPickerActivity;
import cn.bingoogolapple.photopicker.activity.CCRPhotoPickerPreviewActivity;
...
public class MomentAddActivity extends CCRPPToolbarActivity implements EasyPermissions.PermissionCallbacks, CCRSortableNinePhotoLayout.Delegate {
     ...
     * 拖拽排序九宫格控件
     */
    private CCRSortableNinePhotoLayout mPhotosSnpl;
    // ==================================== 测试拖拽排序九宫格图片控件 END ====================================
    ...
    @Override
    public void onNinePhotoItemExchanged(CCRSortableNinePhotoLayout sortableNinePhotoLayout, int fromPosition, int toPosition, ArrayList<String> models) {
    ...
    private void choicePhotoWrapper() {
        ...
        if (EasyPermissions.hasPermissions(this, perms)) {
            ...
            File takePhotoDir = new File(Environment.getExternalStorageDirectory(), "CCRPhoto");

            Intent photoPickerIntent = new CCRPhotoPickerActivity.IntentBuilder(this)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == RC_CHOOSE_PHOTO) {
            if (mSingleChoiceCb.isChecked()) {
                mPhotosSnpl.setData(CCRPhotoPickerActivity.getSelectedPhotos(data));
            } else {
                mPhotosSnpl.addMoreData(CCRPhotoPickerActivity.getSelectedPhotos(data));
            }
        } else if (requestCode == RC_PHOTO_PREVIEW) {
            mPhotosSnpl.setData(CCRPhotoPickerPreviewActivity.getSelectedPhotos(data));
        }
    }
}