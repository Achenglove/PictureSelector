 ...
 */
public class SystemGalleryActivity extends CCRPPToolbarActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        File takePhotoDir = new File(Environment.getExternalStorageDirectory(), "CCRPhotoPickerTakePhoto");
        mPhotoHelper = new CCRPhotoHelper(takePhotoDir);
    }
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_CODE_CHOOSE_PHOTO) {
                try {
                    ...
                    CCRPhotoPickerUtil.show(R.string.bga_pp_not_support_crop);
                    e.printStackTrace();
                }
                ...
                CCRImage.display(mAvatarIv, R.mipmap.bga_pp_ic_holder_light, mPhotoHelper.getCropFilePath(), CCRBaseAdapterUtil.dp2px(200));
            }
        } else {
