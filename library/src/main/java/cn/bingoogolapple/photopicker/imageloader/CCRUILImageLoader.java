...
public class CCRUILImageLoader extends CCRImageLoader {
    ...
    private void initImageLoader() {
        if (!ImageLoader.getInstance().isInited()) {
            ...
            ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(CCRBaseAdapterUtil.getApp()).threadPoolSize(3).defaultDisplayImageOptions(options).build();
